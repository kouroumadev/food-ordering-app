        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">Modifier le Menu 4</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="row justify-content-center">
            ...
            <a href="{{ route('menu.menu4.final') }}" class="btn btn-primary rounded text-center">Voir le menu</a>





            <form method="POST" action="{{ route('menu.menu4.store') }}" id="">
                @csrf
                <hr>
                <div class="row justify-content-center">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="type_id" id="type_id" class="form-control" required >
                                ...
                                <option value="Vin">Boisson Alcoolisée</option>
                                <option value="tea">Boisson non Alcoolisée</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="prod_id" id="prod_1_1_4" class="form-control" required onchange="getImg('prod_1_1_4','img_1_1_4')">
                    ...
                    <div class="col-md-1">
                        <img src="" alt="No Image" class="rounded" id="img_1_1_4" style="height: 80px;" >
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
