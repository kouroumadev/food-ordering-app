        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">Modifier le Menu 2</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="row justify-content-center">
            ...
            <a href="{{ route('menu.menu2.final') }}" class="btn btn-primary rounded text-center">Voir le menu</a>





            <form method="POST" action="{{ route('menu.menu2.store') }}" id="">
                @csrf
                <hr>
                <div class="row justify-content-center">
                    <div class="col-md-3">
